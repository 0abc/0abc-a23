...
/**
 * Reload the selectable values in the filters. The filters depend on g_Settings and g_Replays
...
function filterReplay(replay)
{
	...
	// Filter by single-player / multiplayer.
	let singleplayerFilter = Engine.GetGUIObjectByName("singleplayerFilter");
	...
	if (keywords.length)
	{
		// We just check if all typed words are somewhere in the player list of that replay.
