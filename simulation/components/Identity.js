...
Identity.prototype.Schema =
  ...
  "</optional>" +
  "<optional>" +
    "<element name='VisibleClasses' a:help='Optional list of space-separated classes applying to this entity. These classes will also be visible in various GUI elements. If the classes need spaces, underscores will be replaced with spaces. Choices include: Archer, Axeman, Barracks, Barque, Biga, Blacksmith, BoltShooter, Builder, Camel, Catapult, Cavalry, Centre, Champion, Chariot, Citizen, City, Civic, CivilCentre, Corral, Crossbowman, DefenseTower, Dock, Dog, Economic, Elephant, ElephantStables, Embassy, Farmstead, Field, Fireship, Galley, Gatherer, Healer, Hero, House, Infantry, Javelinist, Lancer, Maceman, Market, Mechanical, Melee, Mercenary, Military, Monument, Outpost, Palace, Pikeman, Quadriga, Ram, Ranged, Relic, Resource, Sabreman, SentryTower, Ship, Shipyard, Siege, SiegeTower, Slave, Slinger, Soldier, Spearman, Stables, Storehouse, Support, Swordsman, Temple, Town, Trader, Village, Warship, Wonder, Worker, Workshop'>" +
      "<attribute name='datatype'>" +
        "<value>tokens</value>" +
      "</attribute>" +
      "<text/>" +
