...
Identity.prototype.Schema =
	...
	"</optional>" +
	"<optional>" +
		"<element name='Classes' a:help='Optional list of space-separated classes applying to this entity. Choices include: Apadana, ArmyCamp, Ashoka, BarterMarket, CitizenSoldier, ConquestCritical, DropsiteFood, DropsiteMetal, DropsiteStone, DropsiteWood, FemaleCitizen, FishingBoat, ForestPlant, GarrisonFortress, GarrisonTower, Human, Immortal, Juggernaut, Kennel, LandTrader, LargeTower, Lighthouse, LongWall, Market, MercenaryCamp, Monument, Mounted, NavalMarket, NavalTrader, Player, SeaCreature, SmallTower, SpecialBuilding, Structure, Syssiton, Unit.'>" +
	...
	"</optional>" +
	"<optional>" +
		"<element name='VisibleClasses' a:help='Optional list of space-separated classes applying to this entity. These classes will also be visible in various GUI elements. If the classes need spaces, underscores will be replaced with spaces. Choices include: Animal, Archer, Axeman, Barge, Barracks, Biga, Bireme, BoltShooter, Builder, Camel, Cavalry, Centre, Champion, Chariot, City, Civic, Colony, Corral, Crossbowman, Defensive, Dock, Dog, Domestic, Economic, Elephant, ElephantStable, Embassy, Farmstead, Field, Fireship, Forge, Fortress, Galley, Gates, Gatherer, Healer, Hero, House, Infantry, Javelineer, Lancer, Maceman, Melee, Mercenary, Metropolis, Military, Naval, Organic, Outpost, Palace, Palisade, Penteconter, Pikeman, Quadriga, Quadrireme, Quinquereme, Ram, Range, Ranged, Relic, Resource, Sabreman, Ship, Shipyard, Siege, SiegeTower, Slave, Slinger, Soldier, Spearman, Stable, StoneThrower, StoneWall, Storehouse, Support, Swordsman, Temple, Theatre, Tower, Town, Trader, Triaconter, Trireme, Village, Warship, Wonder, WoodenWall, Worker.'>" +
			"<attribute name='datatype'>" +
				"<value>tokens</value>" +
			"</attribute>" +
			"<text/>" +
