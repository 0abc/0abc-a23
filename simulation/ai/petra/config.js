...
m.Config = function(difficulty, behavior)
{
  ...
  this.buildings =
  {
    ...
    "cart": ["structures/{civ}/embassy_celtic", "structures/{civ}/embassy_iberian",
       "structures/{civ}/embassy_italiote"],
    "gaul": ["structures/{civ}/rotarymill"],
    "iber": ["structures/{civ}/pillar"],
    "kush": ["structures/{civ}/pyramid_large", "structures/{civ}/blemmye_camp", "structures/{civ}/nuba_village"],
    "mace": [],
    "maur": ["structures/{civ}/pillar"],
    "pers": ["structures/{civ}/apadana"],
